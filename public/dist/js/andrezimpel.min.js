...
$(document).ready(function(){$("[data-toggle='tooltip']").tooltip(),console.log("Hi, there. Stop sniffin that code!"),$("a").attr("target","_blank"),$.ajax({url:"http://www.yum.de/twitter-feed/index.php",dataType:"jsonp",success:function(t){var a=t[0],e=a.text;autolinked_text=twttr.txt.autoLink(e);var n=a.created_at;n=moment(n).format("MMM Do");var r=$("#tweet .tweet-text"),o=$("#tweet .tweet-created-at small");r.html(autolinked_text),o.html(n),$("a").attr("target","_blank")},error:function(t){console.log(t)}}),next_url="https://api.instagram.com/v1/users/25839218/media/recent?access_token=25839218.1fb234f.2a30fb530b2a46c9a62a733d6b8aa693",$.ajax({method:"GET",url:next_url,dataType:"jsonp",jsonp:"callback",jsonpCallback:"jsonpcallback",success:function(t){recent=t.data[0],image=recent.images.standard_resolution.url,caption=recent.caption.text,$container=$("#instagram-recent-image"),$container.attr("src",image),$(".instagram-recent-image").find("a").attr("href",recent.link),$("a").attr("target","_blank"),$caption=$("#instagram-recent-caption"),$caption.html(caption)},error:function(){$("#log").val($("#log").val()+"Error\n")}})});